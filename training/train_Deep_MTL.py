...
#labels ripeness
y_true_ripeness = tf.compat.v1.placeholder(tf.float32, shape=[None, num_classes_ripeness], name='y_true_ripe')
y_true_cls_ripeness = tf.argmax(y_true_ripeness, axis=1)

#labels quality
y_true_quality = tf.compat.v1.placeholder(tf.float32, shape=[None, num_classes_quality], name='y_true_quality')
